...
**Métrica de Avaliação:** Priorização do Recall. Em um contexto de segurança energética, minimizar falsos negativos (não prever um risco real) é mais crítico do que a acurácia geral. Tanto Recall quanto Accuracy oscilaram na casa dos 70%.
